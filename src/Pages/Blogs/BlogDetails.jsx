...
const BlogDetails = () => {
    return (
        <>
            <PageHeader activeClass02='active' routeName02='Blog Details' routeName01='Blog' heading='Use of modern Technology in Road constructio' />
                                ...
                                <div className="blog_details_inner">
                                    <div className="post_content">
                                        <div className="post_header">
                                            ...
                                            <h3 className="post_title">Use of modern Technology in Road construction</h3>
                                        </div>
                                        <div className="fulltext">
                                            ...
                                            <p className="highlight">Over the last 35 Years we made an impact that is strong and we have long
                                                way to go. Excepteur sint occaecat.
                                            </p>
